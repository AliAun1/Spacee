...
//     version 1.4.4
//     from Assets/SpaceCombat/InputSystem/SCK/SCKInputAsset.inputactions
//
    ...
    public struct CapitalShipControlsActions
    {
        ...
        public void SetCallbacks(ICapitalShipControlsActions instance)
        {
            if (m_Wrapper.m_CapitalShipControlsActionsCallbackInterface != null)
            {
                ...
                @Look.started -= m_Wrapper.m_CapitalShipControlsActionsCallbackInterface.OnLook;
                @Look.performed -= m_Wrapper.m_CapitalShipControlsActionsCallbackInterface.OnLook;
                @Look.canceled -= m_Wrapper.m_CapitalShipControlsActionsCallbackInterface.OnLook;
            }

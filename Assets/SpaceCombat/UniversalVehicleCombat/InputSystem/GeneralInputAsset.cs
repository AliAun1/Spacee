...
//     version 1.4.4
//     from Assets/SpaceCombat/UniversalVehicleCombat/InputSystem/GeneralInputAsset.inputactions
//
...
public partial class @GeneralInputAsset : IInputActionCollection2, IDisposable
{
    ...
    public struct GeneralControlsActions
    {
        ...
        public void SetCallbacks(IGeneralControlsActions instance)
        {
            ...
            {
                @Menu.started -= m_Wrapper.m_GeneralControlsActionsCallbackInterface.OnMenu;
                @Menu.performed -= m_Wrapper.m_GeneralControlsActionsCallbackInterface.OnMenu;
                @Menu.canceled -= m_Wrapper.m_GeneralControlsActionsCallbackInterface.OnMenu;
                ...
                @Back.started -= m_Wrapper.m_GeneralControlsActionsCallbackInterface.OnBack;
                @Back.performed -= m_Wrapper.m_GeneralControlsActionsCallbackInterface.OnBack;
                @Back.canceled -= m_Wrapper.m_GeneralControlsActionsCallbackInterface.OnBack;
            }
    ...
    private ITargetingControlsActions m_TargetingControlsActionsCallbackInterface;
    ...
    public struct TargetingControlsActions
    {
        ...
        {
            if (m_Wrapper.m_TargetingControlsActionsCallbackInterface != null)
            {
                @TargetNext.started -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetNext;
                @TargetNext.performed -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetNext;
                @TargetNext.canceled -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetNext;
                @TargetPrevious.started -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetPrevious;
                @TargetPrevious.performed -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetPrevious;
                @TargetPrevious.canceled -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetPrevious;
                @TargetNearest.started -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetNearest;
                @TargetNearest.performed -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetNearest;
                @TargetNearest.canceled -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetNearest;
                @TargetFront.started -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetFront;
                @TargetFront.performed -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetFront;
                @TargetFront.canceled -= m_Wrapper.m_TargetingControlsActionsCallbackInterface.OnTargetFront;
            }
            m_Wrapper.m_TargetingControlsActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    private IWeaponControlsActions m_WeaponControlsActionsCallbackInterface;
    ...
    public struct WeaponControlsActions
    {
        ...
        {
            if (m_Wrapper.m_WeaponControlsActionsCallbackInterface != null)
            {
                @FirePrimary.started -= m_Wrapper.m_WeaponControlsActionsCallbackInterface.OnFirePrimary;
                @FirePrimary.performed -= m_Wrapper.m_WeaponControlsActionsCallbackInterface.OnFirePrimary;
                @FirePrimary.canceled -= m_Wrapper.m_WeaponControlsActionsCallbackInterface.OnFirePrimary;
                @FireSecondary.started -= m_Wrapper.m_WeaponControlsActionsCallbackInterface.OnFireSecondary;
                @FireSecondary.performed -= m_Wrapper.m_WeaponControlsActionsCallbackInterface.OnFireSecondary;
                @FireSecondary.canceled -= m_Wrapper.m_WeaponControlsActionsCallbackInterface.OnFireSecondary;
            }
            m_Wrapper.m_WeaponControlsActionsCallbackInterface = instance;
            if (instance != null)
            {

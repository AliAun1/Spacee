...
//     version 1.4.4
//     from Assets/SpaceCombat/UniversalVehicleCombat/InputSystem/LoadoutInputAsset.inputactions
//
...
public partial class @LoadoutInputAsset : IInputActionCollection2, IDisposable
{
    ...
    private ILoadoutControlsActions m_LoadoutControlsActionsCallbackInterface;
    ...
    public struct LoadoutControlsActions
    {
        ...
        {
            if (m_Wrapper.m_LoadoutControlsActionsCallbackInterface != null)
            {
                @Look.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnLook;
                @Look.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnLook;
                @Look.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnLook;
                @Back.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnBack;
                @Back.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnBack;
                @Back.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnBack;
                @Menu.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnMenu;
                @Menu.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnMenu;
                @Menu.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnMenu;
                @Start.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnStart;
                @Start.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnStart;
                @Start.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnStart;
                @Accept.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnAccept;
                @Accept.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnAccept;
                @Accept.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnAccept;
                @CycleModuleSelection.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleModuleSelection;
                @CycleModuleSelection.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleModuleSelection;
                @CycleModuleSelection.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleModuleSelection;
                @CycleModuleMountSelection.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleModuleMountSelection;
                @CycleModuleMountSelection.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleModuleMountSelection;
                @CycleModuleMountSelection.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleModuleMountSelection;
                @CycleVehicleSelection.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleVehicleSelection;
                @CycleVehicleSelection.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleVehicleSelection;
                @CycleVehicleSelection.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnCycleVehicleSelection;
                @Delete.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnDelete;
                @Delete.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnDelete;
                @Delete.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnDelete;
            }
            m_Wrapper.m_LoadoutControlsActionsCallbackInterface = instance;
            if (instance != null)
            {
